...
<<<<<<< .mine
$tinybrowser['path']['image'] = '/uploads/'.$_REQUEST["idparceiro"].'/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploads/'.$_REQUEST["idparceiro"].'/media/'; // Media files location
$tinybrowser['path']['file']  = '/uploads/'.$_REQUEST["idparceiro"].'/files/'; // Other files location
||||||| .r835
$tinybrowser['path']['image'] = '/uploads_publico/'.$_REQUEST["idparceiro"].'/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploads_publico/'.$_REQUEST["idparceiro"].'/media/'; // Media files location
$tinybrowser['path']['file']  = '/uploads_publico/'.$_REQUEST["idparceiro"].'/files/'; // Other files location
=======
