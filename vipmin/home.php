...
if($acao=="config"){
	...
	if(!$rs){
		echo "Não foi possível fazer a atualização da home.". mysqli_error(DB::$mConnection); 
	}
	...
	if(!$rs){
		echo "Não foi possível fazer a atualização da home para esta cidade. ". mysqli_error(DB::$mConnection); 
	}
	else{
