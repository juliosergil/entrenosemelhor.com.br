...
// maxlife_comentado  //ini_set('session.gc_maxlifetime', 86400);
...
error_reporting(E_ALL^E_WARNING^E_NOTICE^E_DEPRECATED);ini_set('allow_url_include', '0');ini_set('allow_url_include', 'off');ini_set('allow_url_include', 'false');
...
/* important function */
spl_autoload_register("my_autoloader");function my_autoloader($class_name) {
