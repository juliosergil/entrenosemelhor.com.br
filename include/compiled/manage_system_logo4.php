				...
				if($dh){
					...
					while ($file = readdir($dh)){
						...
						<div class="sect" style="background:#ADD8E6;width:881px;">
							<p  id="f1_upload_process">Carregando...<br/></p><br><a target="_blank" href="https://resizeyourimage.com/PT/">Clique aqui para redimensionar sua imagem</a><br><a target="_blank" href="http://www.youtube.com/watch?v=uyCbxw7lU4Q">Veja como é fácil</a>
							<br>
							<p id="result"></p>
	...
	function stopUpload(success){
      ...
      if (success == 1){
           jQuery(document).ready(function(){   
				jQuery.colorbox({html:"<font color=blue>O arquivo foi carregado com sucesso. Agora acesse o site e aperte CTRL + F5 para remover o cache do navegador. Dimensões exatas, parabéns.</font>"});
		   });
      }   
	 else if (success == 2){
