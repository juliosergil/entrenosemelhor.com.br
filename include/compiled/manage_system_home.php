...
<script>
	...
	function stopUpload(success){
      ...
      if (success == 1){
           jQuery(document).ready(function(){   
				jQuery.colorbox({html:"<font color=#336699>O arquivo foi carregado com sucesso. Agora acesse o site e aperte CTRL + F5 para remover o cache do navegador. Dimensões exatas, parabéns.</font>"});
		   });
      }   
	 else if (success == 2){
