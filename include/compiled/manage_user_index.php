		...
		<div class="box clear"> 
            <div class="box-content">
               	<div class="option_box"> 
					<div class="top-heading group"> <div class="left_float"><h4>Usuários</h4></div> 
						<div style="padding: 10px;">	
							<ul id="log_tools"> <li id="log_switch_referral"><a title="Cadastrar novo anunciante" href="/vipmin/user/edit.php">Novo anunciante</a></li> </ul>
							<ul id="log_tools"> <li id="log_switch_referral"><a title="Consultar todos os anunciantes cadastrados" href="/vipmin/user/index.php">Todos os anunciantes</a></li> </ul>
					 	</div>	
					</div> 
                ...
                <div class="sect" style="clear:both;">
					...
					<!-- <th width="30">CPF <input type="text"  value="<?=$_REQUEST['cpf']?>" name="cpf"  id="cpf" style="width: 100%;color:#303030;font-size:11px;"></th>-->
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="team-list-id-<?php echo $one['id']; ?>">
					   ...
					   <!--<td><?php echo $one['cpf'];?></td> -->
						...
						<?php if($one['id'] != "1") {?> 
							<a href="/ajax/manage.php?action=userremove&id=<?php echo $one['id']; ?>" class="ajaxlink" ask="Você tem certeza que deseja apagar esse usuário e todos os seus anúncios ?" ><img alt="Excluir" title="Excluir" style="width: 22px;" src="/media/css/i/excluir.png"></a>
						<? } ?>
						</td> 
					</tr>
					<?php }}?>
