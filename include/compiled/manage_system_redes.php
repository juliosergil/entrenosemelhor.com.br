										...
										<div id="option_contents" class="option_contents"> 
											...
											<div class="form-contain group">
												...
												<div class="ends">
													...
													<div class="group">
														<input type="text" name="other[orkut]"  id="other[orkut]" class="format_input ckeditor" value="<?php echo $INI['other']['orkut']; ?>" />  <img style="cursor:help" class="tTip" title="Endereço do seu perfil no Orkut " src="<?= $ROOTPATH ?>/media/css/i/info.png"> 
													</div> 
												</div>
												<!-- =============================  fim coluna direita  =====================================-->
											</div> 
											...
											<div class="form-contain group">
												...
												<div class="starts">								
													<div id="c_vendas">	
														...
														<div class="group">
															<input type="text" name="other[box-facebook]"  id="other[box-facebook]" class="format_input ckeditor" value="<?php echo $INI['other']['box-facebook']; ?>" />  <img style="cursor:help" class="tTip" title="Incluir o endereço da sua pagina no Facebook, ex.: <b>http://www.facebook.com/pages/Tkstore-Desenvolvimento-de-loja-virtual/197184830309643</b>
												...
												<div class="ends"> 
													...
													<div class="group">
														<input type="text" name="other[botao-recomendar]"  id="other[botao-recomendar]" class="format_input ckeditor" value="<?php echo $INI['other']['botao-recomendar']; ?>" />  <img style="cursor:help" class="tTip" title="Endereço do site para recomendar" src="<?= $ROOTPATH ?>/media/css/i/info.png"> 
													</div>
												</div>
											</div>
											<!-- ============================= // fim coluna direita // =====================================-->
											...
											<div class="form-contain group">
												...
												<div class="starts">								
													<div id="c_vendas">	
														...
														<div class="group">
															<input type="text" name="other[usuario_twitter]"  id="other[usuario_twitter]" class="format_input ckeditor" value="<?php echo $INI['other']['usuario_twitter']; ?>" />  <img style="cursor:help" class="tTip" title="Informe apenas o seu usuário do Twitter, para que o bloco Join Conversation seja exibido. Ex: <b>VipcomColetivas</b>
										...
										<div id="option_contents" class="option_contents"> 
											...
											<div class="form-contain group">
												...
												<div class="starts">
													...
													<div class="group">
														<input type="text" name="other[admin_id]"  id="other[admin_id]" class="format_input ckeditor" value="<?php echo $INI['other']['admin_id']; ?>" />  <img style="cursor:help" class="tTip" title="Algo como: <b>127097849026839</b> (Atenção: Não é o seu profile e nem sua página do facebook). Deixe em branco para não usar os comentários." src="<?= $ROOTPATH ?>/media/css/i/info.png"> 
													</div>  
												...
												<div class="ends">
													...
													<div class="group">
														<input type="text" name="other[app_id]"  id="other[app_id]" class="format_input ckeditor" value="<?php echo $INI['other']['app_id']; ?>" />  <img style="cursor:help" class="tTip" title="Algo como: <b>356647589346334</b> (Atenção: Não é o seu profile e nem sua página do facebook). Deixe em branco para não usar os comentários." src="<?= $ROOTPATH ?>/media/css/i/info.png"> 
													</div> 
										...
										<div id="option_contents" class="option_contents"> 
											...
											<div class="form-contain group">
												...
												<div class="starts">
													...
													<div class="group">
														<input type="text" name="other[admin_id_login]"  id="other[admin_id_login]" class="format_input ckeditor" value="<?php echo $INI['other']['admin_id_login']; ?>" />  <img style="cursor:help" class="tTip" title="Algo como: <b>127097849026839</b> (Atenção: Não é o seu profile e nem sua página do facebook). Deixe em branco para não usar o login com facebook." src="<?= $ROOTPATH ?>/media/css/i/info.png"> 
													</div> 
												...
												<div class="ends">
													<div class="report-head">App_id: <span class="cpanel-date-hint"></span></div>
													<div class="group">
														<input type="text" name="other[app_id_login]"  id="other[app_id_login]" class="format_input ckeditor" value="<?php echo $INI['other']['app_id_login']; ?>" />  <img style="cursor:help" class="tTip" title="Diferente do App_id dos comentários. Algo como: <b>356647589346334</b> (Atenção: Não é o seu profile e nem sua página do facebook). Deixe em branco para não usar o login com facebook." src="<?= $ROOTPATH ?>/media/css/i/info.png"> 
													</div> 
