							...
							<div id="option_contents" class="option_contents"> 
								<div class="form-contain group">
									...
									<div class="starts">   
										...
										<div class="group">
											<input type="text" name="title" id="title" class="format_input ckeditor" value="<?php echo $partner['title'] ?>" /> 
										</div>
										
										<div style="clear:both;"class="report-head">Apelido: <span class="cpanel-date-hint"></span></div>
										<div class="group">
											<input type="text" name="username" id="username" class="format_input ckeditor" value="<?php echo $partner['username'] ?>" /> 
										</div>
										
										 <div style="clear:both;"class="report-head">Senha: <span class="cpanel-date-hint"></span></div>
										<div class="group">
											<input type="text" name="password" id="password" class="format_input ckeditor" value="<?php echo $partner['password'] ?>" /> 
										</div>
												 
										<div style="clear:both;"class="report-head">Logo: <span class="cpanel-date-hint"></span></div>
										<div class="group">
											<input type="file" style="border: 1px solid #C1D0D3; color: #666666; width: 86%;" name="upload_image"  id="upload_image" class="format_input ckeditor"   value="<?php  $partner['upload_image'] ; ?>" />  
										</div>	
										 
										<div style="clear:both;"class="report-head">Email: <span class="cpanel-date-hint"></span></div>
										<div class="group">
											<input type="text" name="contact" id="contact" class="format_input ckeditor" value="<?php echo $partner['contact'] ?>" /> 
										</div>	
									...
									<div class="ends"> 	 		 
										...
										<div class="group">
											<input type="text" name="phone"   id="phone" class="format_input ckeditor" value="<?php echo $partner['phone'] ?>" /> 
										</div>
										
										<div style="clear:both;"class="report-head">Celuar: <span class="cpanel-date-hint"></span></div>
										<div class="group">
											<input type="text" name="mobile" id="mobile" class="format_input ckeditor" value="<?php echo $partner['mobile'] ?>" /> 
										</div>		
										
										<div style="clear:both;"class="report-head">Senha: <span class="cpanel-date-hint"></span></div>
										<div class="group">
											<input type="text" name="email" id="email" class="format_input ckeditor" value="<?php echo $partner['email'] ?>" /> 
										</div>	 
										 
										 <div style="clear:both;"class="report-head">Site: <span class="cpanel-date-hint"></span></div>
										<div class="group">
											<input type="text" name="homepage"  id="homepage" class="format_input ckeditor" value="<?php echo $partner['homepage'] ?>" /> 
										</div>  
										<div class="group">
						...
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								...
								<div class="starts">
									...
									<div class="group">
										<input type="text" name="address"   id="address" class="format_input ckeditor"  value="<?php echo $partner['address'] ; ?>"   />  <img style="cursor:help" class="tTip" title="Este endereço será usado para localização do google maps automaticamente. Não informe neste campo dados como bloco, apto, sala , ou qualquer outro dado específico da localidade, não tem como o google achar sua sala ou seu apto. Informe esses dados no campo complemento" src="<?=$ROOTPATH?>/media/css/i/info.png"> 
									</div> 
									...
									<div class="group">
										<input type="text" name="chavesms" id="chavesms" class="format_input ckeditor"  value="<?php echo $partner['chavesms'] ; ?>"   />   
									</div> 
								...
								<div class="ends"> 
									...
									<div class="group">
										<input type="text" name="cep"   id="cep" class="format_input ckeditor"  value="<?php echo $partner['cep'] ; ?>"   />  
									</div> 
									...
									<div class="group">
										<input type="text" name="longlat" id="longlat" class="format_input ckeditor"  value="<?php echo $partner['longlat'] ; ?>"   />   
									</div> 
									<div style="clear:both;"class="report-head">Cidade: <span class="cpanel-date-hint"></span></div>
									<div class="group">
										<input type="text" name="cidade"   id="cidade" class="format_input ckeditor"  value="<?php echo $partner['cidade'] ; ?>"   />  
