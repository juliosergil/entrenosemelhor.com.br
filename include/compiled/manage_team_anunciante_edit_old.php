            ...
            <div class="box-content">
					...
					<div class="top-heading group" style="padding:0 !important;padding-top:5px !important;">
						...
						<div class="the-button col-md-6 col-xs-12 col-sm-12">  
							...
							<div class="col-md-3 col-xs-12 col-sm-12">
								<button onclick="doupdate();" id="run-button" class="input-btn btn btn-success" type="button"><div name="spinner-top" id="spinner-top" style="width: 83px; display: block;"><img name="imgrec" id="imgrec" src="<?=$ROOTPATH?>/media/css/i/lendo.gif" style="display: none;"></div> Salvar </button>
							</div>
							<div class="col-md-3 col-xs-12 col-sm-12">
					...
					<div class="top-heading group"> 
						<div class="left_float">
							<span class="style2" style="margin-left:5px;">   
								Imagens do anúncio </span><span class="style5"> </span></div> 
					</div> 
					<div id="container_box">
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								<!-- =============================   coluna esquerda   =====================================-->
								<div class="starts col-md-6 col-xs-12 col-sm-12 col-md-6 col-xs-12 col-sm-12">  
									<div style="clear:both;"class="report-head">Foto 1:  <span class="cpanel-date-hint"><span id="dimensao"></span>  </span> 
									</div>
									<div class="group">
				...
				<div class="option_box" id="c_estaticas" style="display:none;">
					<div class="top-heading group"> 
						<div class="left_float">
							<h4>
								Imagens Estáticas ( Não redimensiona - Opcional )
							</h4> 
						</div> 
					</div> 
					<div id="container_box">
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								...
								<div class="starts col-md-6 col-xs-12 col-sm-12 col-md-6 col-xs-12 col-sm-12">  
									...
									<div style="clear:both;"class="report-head">Detalhe: <span class="cpanel-date-hint">Dimensão exata: 370px x 278px.</span>     </div>
									<div class="group">
