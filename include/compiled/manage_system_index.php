        ...
        <div class="clear box">
            ...
            <div class="box-content"> 
                <div class="sect">
					...
					<div class="option_box">
						...
						<div id="container_box">
							<div id="option_contents" class="option_contents"> 
								<div class="form-contain group">
									...
									<div class="starts"> 
										...
										<div style="clear:both;"class="report-head">Subtítulo: <span class="cpanel-date-hint">Ex: Seu site de classificados</span></div>
										<div class="group">
											<input type="text" name="system[sitetitle]" class="format_input ckeditor" value="<?php echo $INI['system']['sitetitle']; ?>" /> 
										</div>	
										
										
										<div style="clear:both;"class="report-head">Título da Home: <span class="cpanel-date-hint"> </span></div>
										<div class="group">
											<input type="text" name="system[titulohome]" class="format_input ckeditor" value="<?php echo $INI['system']['titulohome']; ?>" /> 
										</div>
										
										<div style="clear:both;"class="report-head">SubTítulo da Home: <span class="cpanel-date-hint"> </span></div>
										<div class="group">
											<input type="text" name="system[subtitulohome]" class="format_input ckeditor" value="<?php echo $INI['system']['subtitulohome']; ?>" /> 
										</div>
										
										
										
										<div style="clear:both;"class="report-head">Título da seção notícias (home): <span class="cpanel-date-hint"> Ex: Notícias do Site</span></div>
										<div class="group">
											<input type="text" name="system[blog]" class="format_input ckeditor" value="<?php echo $INI['system']['blog']; ?>" /> 
										</div>	
										
										<div style="clear:both;"class="report-head">Descrição da seção notícias (home): <span class="cpanel-date-hint"> Ex: Notícias do Site</span></div>
										<div class="group">
											<input type="text" name="system[blogdesc]" class="format_input ckeditor" value="<?php echo $INI['system']['blogdesc']; ?>" /> 
										</div>	
							...
							<div class="pcu">
								...
								<div class="form-contain group"> 
									<div class="text_area">  
									<textarea cols="45" rows="5" name="system[textopagamento]" style="width:100%" class="format_input ckeditor" ><?php echo htmlspecialchars($INI['system']['textopagamento']); ?></textarea>
									</div> 
								</div> 
							</div> 
						</div>
					...
					<? include template('manage_system_index_codigos'); ?><input type="text"  style="display:none;" name="system[currencyname]" class="number" value="BRL"/>  
