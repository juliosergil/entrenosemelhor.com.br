...
<link rel="stylesheet" type="text/css" href="/media/css/novo.css"/> 
<link rel="stylesheet" type="text/css" href="/media/css/anunciante_modern.css"/> 

<script type="text/javascript">	
	$(document).ready(function(){		
	$('.tTip').betterTooltip({speed: 100, delay: 30});	});
</script> 
<div id="hdw" style="display:none;color:#FFF;background:url('<?=$ROOTPATH?>/media/js/menu/images/8.jpg') repeat-x scroll 0 0 transparent;">	
	<div id="hd">	 
		<div id="logo" style="height: 92px;">
			<a href="/adminanunciante/index.php" class="link" >
				<img src="/include/logo/logo.png" style="max-width: 330px; max-height:100px;" />
			</a>
		</div>
		<? 
		 ...
		 ;
			if($_SESSION['user_id']){					
				$user = Table::Fetch('user', $_SESSION['user_id']);
				$realname = $user['realname'];
			}		
		?>		
		<div class="guides" style="top:3px;width:300px;" > 
			<div style="font-size:11px;color:#303030;">
				<?php if($_SESSION['user_id']){ echo "Usuário Logado: ". $realname. " ( Código ". $_SESSION['user_id']." )"; } ?>
			</div>		
		</div>  		
		<?php if($_SESSION['user_id']){require_once("menu_anunciante.php");}?> 		
		<?php if(need_anunciante()){?>
		<div class="vcoupon">
			&raquo;&nbsp;
			<a href="/sairanunciante">
...
<nav class="navbar navbar-inverse navbar-static-top" role="navigation">	
    <div class="navbar-header">
        ...
        <button type="button"
            ...
            <span class="icon-bar" style="margin:4px auto; width:20px;"></span>
            <span class="icon-bar" style="margin:4px auto; width:20px;"></span>
            <span class="icon-bar" style="margin:4px auto; width:20px;"></span>
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">	
		...
		<li class="active hidden-xs hidden-sm" style="padding: 0 19px 2px 0;">	
				<a class='rmbkack' href="<?php echo $ROOTPATH; ?>/adminanunciante/index.php">	
					<img class="img-responsive logoanunciantedkop" src="<?php echo $ROOTPATH; ?>/include/logo/logo.png"  >		
				</a>	
			</li>	
		 
					
			<li style="color:#fff;margin-left: 7px;margin-top: 14px;">  
				<?php if($_SESSION['user_id']){ echo "Bem Vindo: ". $realname. " ( Código ". $_SESSION['user_id']." )"; } ?>
			...
			<li>	
				<a href="<?php echo $ROOTPATH; ?>?page=meusdados">	
					Meus Dados	
				</a>		
			</li> 		
			<li> 
				<a href="<?php echo $ROOTPATH; ?>/adminanunciante/team/propostas.php">
					Propostas
				</a>
			</li>  			
