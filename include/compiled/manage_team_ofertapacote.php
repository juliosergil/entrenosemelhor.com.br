						...
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								...
								<div class="starts">
									...
									<div class="group">
										<input type="text" name="title"  maxlength="162" id="title" class="format_input ckeditor" value="<?php echo htmlspecialchars($team['title']); ?>" />  <img style="cursor:help" class="tTip" title="Se você tem 3 opções de uma mesma oferta com valores diferentes para cada opção, então crie 3 ofertas e associe em um mesmo pacote. Ex: 3, 5 ou 10 sessões de Peeling..." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
									</div> 
							...
							<div class="form-contain group">
								...
								<div class="starts">
									<div id="c_vendas">	
										...
										<div class="group">
											<input type="text" name="min_number"   onKeyPress="return SomenteNumero(event);"  id="min_number" class="format_input ckeditor"  value="<?php echo intval($team['min_number']); ?>" maxLength="6"  />  <img style="cursor:help" class="tTip" title="Quantidade mínima necessária para ativar esta oferta. Note que o cupom só será enviado automaticamente após esse valor ser alcançado.Lembre-se de seguir os passos para a integração com o gateway" src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 	
									 
										<div style="clear:both;"class="report-head">Quantidade mínima por pessoa: <span class="cpanel-date-hint"></span></div>
										<div class="group">
											<input type="text" name="minimo_pessoa"  onKeyPress="return SomenteNumero(event);"   id="minimo_pessoa" class="format_input ckeditor"  value="<?php echo intval($team['minimo_pessoa']); ?>" maxLength="6"  />  <img style="cursor:help" class="tTip" title="Quantidade mínima para finalizar o pedido. Ex: Para comprar esta oferta, o cliente deverá comprar 5 unidades ou mais." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
									...
									<div id="c_estoque">
										...
										<div class="group">
											<input type="text" name="per_number"  onKeyPress="return SomenteNumero(event);"   id="per_number" class="format_input ckeditor"  value="<?php echo intval($team['per_number']); ?>" maxLength="6"  />  <img style="cursor:help" class="tTip" title="Quantidade máxima que cada cliente poderá comprar." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div>
										
										<div style="clear:both;"class="report-head">Estoque: <span class="cpanel-date-hint"></span></div>
										<div class="group">
											<input type="text" name="max_number"  onKeyPress="return SomenteNumero(event);"  id="max_number" class="format_input ckeditor"  value="<?php echo intval($team['max_number']); ?>" maxLength="6"  />  <img style="cursor:help" class="tTip" title="Quantidade máxima a ser vendida no site." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
									</div> 
									...
									<div id="c_compradores_virtuais">
										...
										<div class="group">
											<input type="text" name="pre_number"  onKeyPress="return SomenteNumero(event);"   id="pre_number" class="format_input ckeditor"  value="<?php echo intval($team['pre_number']); ?>" maxLength="6"  />  <img style="cursor:help" class="tTip" title="Se o total de compradores virtuais + reais for menor do que o mínimo para ativar, o cupom desta oferta avulsa não será enviado mesmo que o pacote esteja ativo." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div>
									</div>
								...
								<div class="ends"> 
									...
									<div class="group">
									 ...
									 <div  id="cupomate">
										...
										<div class="group">
											<input style="width:40%;" type="text"  xd="<?php echo date('d/m/Y', $team['expire_time']); ?>" name="expire_time" id="expire_time" class="format_input ckeditor"  maxlength="10"  value="<?php echo date('d/m/Y', $team['expire_time']); ?>"/>
							...
							<div class="form-contain group">
								...
								<div class="starts">   
									<div id="c_valores">
										...
										<div class="group">
											<input type="text" name="market_price" maxlength="11"  id="market_price" class="format_input ckeditor"   value="<?php echo $team['market_price'] ; ?>" />  <img style="cursor:help" class="tTip" title="Valor antigo da oferta." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
										 
										<div style="clear:both;"class="report-head">Por: <span class="cpanel-date-hint"></span></div>
										<div class="group">
											<input type="text" name="team_price"  id="team_price" maxlength="11" class="format_input ckeditor"   value="<?php echo  $team['team_price'] ; ?>"  />  <img style="cursor:help" class="tTip" title="Valor atual da oferta" src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 	
									</div>
									<!--
									<div id="c_comissao">
										...
										<div class="group">
											<input type="text" name="preco_comissao"  id="preco_comissao" maxlength="11" class="format_input ckeditor"   value="<?php echo  $team['preco_comissao'] ; ?>"   />  <img style="cursor:help" class="tTip" title="O cliente paga um valor pequeno pelo cumpom para garantir o desconto no parceiro. Se você está vendendo um produto de um site, sugerimos informar na descrição da oferta a url deste produto, para que o usuário veja realmente a diferença do preço do produto. Isto é ideal, uma vez que ele irá ver a economia comprando o seu cupom." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
									</div> 
									-->
									<!--
							...
							<div id="option_contents" class="option_contents">  
								<div class="form-contain group">
									...
									<div class="starts">
										...
										<div class="group">
											<input type="text" name="ceporigem"  maxlength="162" id="ceporigem" class="format_input ckeditor" value="<?php echo  $team['ceporigem'] ; ?>" />  <img style="cursor:help" class="tTip" title="O valor do frete será calculado baseado no cep de origem. Ou seja, o cep de onde este produto está sendo enviado." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
										<div style="clear:both;"class="report-head">Peso: <span class="cpanel-date-hint">Peso mínimo : 1</span></div>
										<div class="group">
											<input type="text" name="peso"  maxlength="162" id="peso" class="format_input ckeditor" value="<?php echo  $team['peso'] ; ?>" />  <img style="cursor:help" class="tTip" title="O valor do frete será calculado baseado no peso deste produto." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
										<div style="clear:both;"class="report-head">Altura: <span class="cpanel-date-hint">Altura mínima: 2</span></div>
										<div class="group">
											<input type="text" name="altura"  maxlength="162" id="altura" class="format_input ckeditor" value="<?php echo  $team['altura'] ; ?>" />  <img style="cursor:help" class="tTip" title=" O valor do frete será calculado baseado na altura deste produto." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div>
									...
									<div class="ends">
										...
										<div class="group">
											<input type="text" name="largura"  maxlength="162" id="largura" class="format_input ckeditor" value="<?php echo  $team['largura'] ; ?>" />  <img style="cursor:help" class="tTip" title="O valor do frete será calculado baseado na largura deste produto." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
										<div style="clear:both;"class="report-head">Comprimento: <span class="cpanel-date-hint">Comprimento mínimo: 16</span></div>
										<div class="group">
											<input type="text" name="comprimento"  maxlength="162" id="comprimento" class="format_input ckeditor" value="<?php echo  $team['comprimento'] ; ?>" />  <img style="cursor:help" class="tTip" title="O valor do frete será calculado baseado no comprimento deste produto." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div>	
										...
										<div class="group">
											<input type="text" name="valorfrete"  maxlength="162" id="valorfrete" class="format_input ckeditor" value="<?php echo  $team['valorfrete'] ; ?>" />  <img style="cursor:help" class="tTip" title="Você pode alterar o valor do frete, neste caso, o sistema irá usar o valor que você escolher." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
						...
						<div class="top-heading group"> <div class="left_float"><h4>Descrição de retorno da Participação (opcional)</h4> </div> &nbsp;<img class="tTip" title="Quando o usuário clicar em 'Quero Participar', a participação dele será registrada no sistema, e ainda, você pode definir o Feedback para o usuário, ou seja, o conteúdo da página que ele irá visualizar após o registro. Você pode criar uma página no dreamweaver e depois colocar o código fonte aqui." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png"> </div> 
						 <div id="container_box">
							<div id="option_contents" class="option_contents">  
								<div class="form-contain group"> 
									<div class="text_area">  
									<textarea cols="45" rows="5" name="retornoparticipe" style="width:100%" id="retornoparticipe" class="format_input ckeditor" ><?php echo htmlspecialchars($team['retornoparticipe']); ?></textarea>
									</div> 
								</div> 
							</div> 
						</div>
						...
						<div class="top-heading group"> <div class="left_float"><h4>Informações na Tela de Pagamento (opcional)</h4> </div> </div> 
						 <div id="container_box">
							<div id="option_contents" class="option_contents">  
								<div class="form-contain group"> 
									<div class="text_area">  
									 <textarea cols="45" rows="5" name="detail" style="width:100%" id="detail" class="format_input ckeditor" ><?php echo htmlspecialchars($team['detail']); ?></textarea>
									</div> 
								</div> 
							</div> 
						</div>
