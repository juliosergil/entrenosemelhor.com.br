						...
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								...
								<div class="starts">
									...
									<div class="group">
										<input type="text" name="title"  maxlength="162" id="title" class="format_input ckeditor" value="<?php echo htmlspecialchars($team['title']); ?>" />  <img style="cursor:help" class="tTip" title="Ex de um nome de pacote: 3, 5 ou 10 sessões de secagem de peeling com luz pulsada intensa, a partir de R$ 49,90." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
									</div> 
							...
							<div class="form-contain group">
								...
								<div class="starts">
									...
									<div id="c_compradores_virtuais">
										...
										<div class="group">
											<input type="text" name="pre_number"  onKeyPress="return SomenteNumero(event);"   id="pre_number" class="format_input ckeditor"  value="<?php echo intval($team['pre_number']); ?>" maxLength="6"  />  <img style="cursor:help" class="tTip" title="Ideal para questões de marketing. Se informar 10 neste campo, quer dizer que já ouve 10 compradores deste pacote. Este campo será incrementado na venda de cada oferta avulsa inclusa neste pacote." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div>
									</div>
									<!--
