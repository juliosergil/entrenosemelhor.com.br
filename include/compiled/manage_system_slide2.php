...
<?php require("ini.php");?> 
 <? $_SESSION['pasta']='banners';  // USADO EM util/UPLOADHANDLER.PHP ?> 									 
	...
	<div id="content" class="clear mainwide">
        <div class="clear box"> 
            <div class="box-content">
                <div class="sect">
				<form id="nform" id="nform"  method="post" action="/vipmin/system/slide2.php" enctype="multipart/form-data" class="validator">
				<input type="hidden" id="id" name="id" value="<?php echo $team['id']; ?>" /> 
				<div class="option_box">
				 <div class="top-heading group">
					<div class="left_float"><h4>Slide de Imagens - Resolução ideal: 1920px largura x 1100px altura) ( jpg, png)</h4></div>
					...
					<div id="option_contents" class="option_contents"> 
						<div class="form-contain group">
							<div class="starts">
								...
								<div class="group">
									<input type="text" name="background[intervalo]"  maxlength="10" id="title" class="format_input ckeditor" value="<?php echo htmlspecialchars($INI['background']['intervalo']); ?>" />  <img style="cursor:help" class="tTip" title="Intervalo de tempo de cada imagem. Ex: 10 segundos. Note que a velocidade mínima deverá ser 3 segundos devido a velocidade de transição." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
								</div> 
								...
								<div class="group">
									<input type="text" name="background[velocidade]"  maxlength="1" id="title" class="format_input ckeditor" value="<?php echo htmlspecialchars($INI['background']['velocidade']); ?>" />  <img style="cursor:help" class="tTip" title="Velocidade de transição na sobreposição de 2 imagens. Ex: 5 segundos" src="<?=$ROOTPATH?>/media/css/i/info.png"> 
								</div> 
							</div> 
						</div> 
					</div>
					...
					<div class="top-heading group"> <div class="left_float"> </div> </div> 
					 <div id="container_box">
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group"> 
								<div class="text_area">  
									<iframe frameborder="0" style="width:100%;height:300px;" scrolling="auto" src="<?=$ROOTPATH?>/util/swfupload/app/index.php"></iframe>
								</div> 
							</div> 
						</div> 
					</div>
				...
				<div  class="option_box">  
						<div class="top-heading group"> <div class="left_float"><h4>Imagens enviadas.</h4> </div> </div> 
						 <div id="container_box">
							<div id="option_contents" class="option_contents">  
								<div class="form-contain group"> 
									<div class="text_area">  
									<? require_once(WWW_ROOT."/vipmin/galeria2.php");?>
									</div> 
								</div> 
							</div> 
						</div>
