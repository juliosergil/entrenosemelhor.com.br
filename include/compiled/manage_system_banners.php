            ...
            <div class="box-content">
				...
				<div class="option_box">
				 <div class="top-heading group">
					<div class="left_float"><h4>Slideshow de Banners - Resolução sugerida: 945x x 271px ( jpg, png, gif ). Evite arquivos com estes caracteres (. - _ ) em sua nomeclatura</h4></div>
