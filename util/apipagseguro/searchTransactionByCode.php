...
class SearchTransactionByCode {
	...
	public static function main($transaction_code) {
		global $INI; 
	    Util::log($transaction_code. " :: Entrando em SearchTransactionByCode");
		try {
			/*
			* #### Crendencials ##### 
			...
			*/		
			...
			Util::log($transaction_code. " :: Erro ao buscar dados em TransactionByCode");
			die($e->getMessage());
		}
	...
	public static function printTransaction(PagSeguroTransaction $transaction) {
		...
		Util::log($transaction->getCode(). " :: Dados capturados em printTransaction");
