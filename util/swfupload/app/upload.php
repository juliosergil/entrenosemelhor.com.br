...
// Check post_max_size (http://us3.php.net/manual/en/features.file-upload.php#73762)
	...
	$save_path = dirname(dirname(dirname(dirname(__FILE__)))) . "/media/".$pathimages."/";
 	...
 	if($_POST["tipo"]=="slideshowbanners"){
	...
	if($_POST["tipo"]=="musica"){

		$save_path = dirname(dirname(dirname(__FILE__))) . "/flashmp3player/mp3/oferta/".$pathimages."/";				// The path were we will save the file (getcwd() may not be reliable and should be tested in your environment)
