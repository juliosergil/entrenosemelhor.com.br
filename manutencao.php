...
<? if($INI['option']['manutencao_padrao']=="s"){?>

	<!-- PAGINA DE  MANUTENCAO PADRAO --> 
	...
	<head> 
		...
		<title><?=utf8_decode($INI['option']['manutencao_padrao_titulo'])?></title>
	...
	<body>
		<section id="default-card" class="default-card">
			<div class="container card">
				<h1 class="title-main"><?=utf8_decode($INI['option']['manutencao_padrao_titulo'])?></h1>
				<p class="subheading"><?=utf8_decode($INI['option']['manutencao_padrao_cabecalho'])?></p>
				...
				<p class="text"><?=utf8_decode($INI['option']['manutencao_padrao_rodape'])?></p>
			</div>
		</section>
				...
				<span class="logo__">  
					<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
						...
						<style type="text/css">
						 ...
						 <img src="/include/logo/logo.png" style="max-width: 118px;max-height: 42px;">
						 </span>
			</div>
...
<? } else { ?>
	...
	<!-- PAGINA DE MANUTENCAO PERSONALIZADA --> 

	<!DOCTYPE html>

	<html>
	<head>
		<title><?php echo utf8_decode($INI['system']['sitename']); ?>- Manuten&ccedil;&atilde;o</title>
	</head>
	<body>
		<?php
			echo utf8_decode($INI['option']['conteudopaginamanutencao']);
		?>
	</body>
	</html>
